...
// responsesTransportOptions carries transport-level configuration for the
// Responses language model: WebSocket streaming support and the suppression
// of the max_output_tokens parameter for backends that reject it.
type responsesTransportOptions struct {
	websocketEnabled bool
	websocketURL     string
	websocketHeaders map[string]string
	disableMaxOutput bool
	baseURL          string
	apiKey           string
...
type responsesLanguageModel struct {
	...
	transportOpts responsesTransportOptions
}

// newResponsesLanguageModel implements a responses api model.
func newResponsesLanguageModel(modelID, provider string, client openai.Client, objectMode fantasy.ObjectMode, transportOpts responsesTransportOptions) responsesLanguageModel {
...
func (o responsesLanguageModel) prepareParams(call fantasy.Call) (*responses.ResponseNewParams, []fantasy.CallWarning, error) {
	...
	if !o.transportOpts.disableMaxOutput && call.MaxOutputTokens != nil {
	...
	if openaiOptions != nil {
		...
		if openaiOptions.TextVerbosity != nil {
			params.Text = responses.ResponseTextConfigParam{
				Verbosity: responses.ResponseTextConfigVerbosity(*openaiOptions.TextVerbosity),
			}
		}
...
func (o responsesLanguageModel) Stream(ctx context.Context, call fantasy.Call) (fantasy.StreamResponse, error) {
	...
	stream := o.openResponsesStream(ctx, call, *params)
