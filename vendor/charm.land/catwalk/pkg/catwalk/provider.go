...
type Model struct {
	...
	// CompactionTriggerTokens is an optional model-specific usage
	// threshold (in tokens) at or above which Crush auto-compacts the
	// session. When 0, the provider-wide context window rules apply.
