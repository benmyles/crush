...
func (m *mockSessionAgent) SetCompactionModel(*Model)           {}
...
func (m *mockSessionAgent) QueuedPromptsList(sessionID string) []QueuedPromptItem {
	return nil
}

func (m *mockSessionAgent) RemoveQueuedPrompt(sessionID string, queueID uint64) bool {
	return false
}
