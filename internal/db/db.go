...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.deleteCompactionCausalityBySessionStmt, err = db.PrepareContext(ctx, deleteCompactionCausalityBySession); err != nil {
		return nil, fmt.Errorf("error preparing query DeleteCompactionCausalityBySession: %w", err)
	}
	if q.deleteCompactionSummariesBySessionStmt, err = db.PrepareContext(ctx, deleteCompactionSummariesBySession); err != nil {
		return nil, fmt.Errorf("error preparing query DeleteCompactionSummariesBySession: %w", err)
	}
	...
	if q.deleteMessagesFromStmt, err = db.PrepareContext(ctx, deleteMessagesFrom); err != nil {
		return nil, fmt.Errorf("error preparing query DeleteMessagesFrom: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.deleteCompactionCausalityBySessionStmt != nil {
		if cerr := q.deleteCompactionCausalityBySessionStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing deleteCompactionCausalityBySessionStmt: %w", cerr)
		}
	}
	if q.deleteCompactionSummariesBySessionStmt != nil {
		if cerr := q.deleteCompactionSummariesBySessionStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing deleteCompactionSummariesBySessionStmt: %w", cerr)
		}
	}
	...
	if q.deleteMessagesFromStmt != nil {
		if cerr := q.deleteMessagesFromStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing deleteMessagesFromStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	deleteCompactionCausalityBySessionStmt *sql.Stmt
	deleteCompactionSummariesBySessionStmt *sql.Stmt
	deleteFileStmt                         *sql.Stmt
	deleteMessageStmt                      *sql.Stmt
	deleteMessagesFromStmt                 *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		deleteCompactionCausalityBySessionStmt: q.deleteCompactionCausalityBySessionStmt,
		deleteCompactionSummariesBySessionStmt: q.deleteCompactionSummariesBySessionStmt,
		deleteFileStmt:                         q.deleteFileStmt,
		deleteMessageStmt:                      q.deleteMessageStmt,
		deleteMessagesFromStmt:                 q.deleteMessagesFromStmt,
