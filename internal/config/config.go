...
type MorphCompactOptions struct {
	Enabled          bool     `json:"enabled,omitempty" jsonschema:"description=Enable Morph Compact for manual session compaction,default=false"`
	APIKey           string   `json:"api_key,omitempty" jsonschema:"description=Morph API key or variable reference,example=$MORPH_API_KEY"`
	BaseURL          string   `json:"base_url,omitempty" jsonschema:"description=Base URL for the Morph API,format=uri,default=https://api.morphllm.com/v1,example=https://api.morphllm.com/v1"`
	CompressionRatio *float64 `json:"compression_ratio,omitempty" jsonschema:"description=Fraction of context to keep,minimum=0.05,maximum=1,default=0.5,example=0.5"`
...
const (
	...
	DefaultMorphCompactPreserveRecent   = 3
)

func (o MorphCompactOptions) EffectiveBaseURL() string {
	return cmp.Or(o.BaseURL, DefaultMorphCompactBaseURL)
}

func (o MorphCompactOptions) EffectiveCompressionRatio() float64 {
	if o.CompressionRatio == nil {
		return DefaultMorphCompactCompressionRatio
	}
	return *o.CompressionRatio
}

func (o MorphCompactOptions) EffectivePreserveRecent() int {
	if o.PreserveRecent == nil {
		return DefaultMorphCompactPreserveRecent
	}
