...
func (s *runCoordinator) QueuedPromptsList(string) []agent.QueuedPromptItem { return nil }
func (s *runCoordinator) RemoveQueuedPrompt(string, uint64) bool            { return false }
func (s *runCoordinator) ClearQueue(string)                                 {}
func (s *runCoordinator) Summarize(context.Context, string) error {
	return nil
}
func (s *runCoordinator) Compact(context.Context, string) error          { return nil }
func (s *runCoordinator) Truncate(context.Context, string, string) error { return nil }
...
func (s *runCoordinator) GetStatus(context.Context, string) (status.Update, error) {
