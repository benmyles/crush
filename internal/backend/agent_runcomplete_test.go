...
func (c *errorCoordinator) SendSubAgentMessage(ctx context.Context, sessionID, text string) error {
	return nil
}
...
func (c *errorCoordinator) Truncate(context.Context, string, string) error    { return nil }
...
func (c *errorCoordinator) GetStatus(context.Context, string) (status.Update, error) {
